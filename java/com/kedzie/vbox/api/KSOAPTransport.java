...
public class KSOAPTransport {
	...
	public Object call(SoapObject object) throws IOException, XmlPullParserException {
		...
		transport.call(VBoxMonitorActivity.NAMESPACE+object.getName(), envelope);
	...
	public <T> T getProxy(Class<T> clazz, String id) {
		return clazz.cast( Proxy.newProxyInstance(VBoxMonitorActivity.class.getClassLoader(), new Class [] { clazz }, new SOAPInvocationHandler(id, clazz.getSimpleName())));
	}
	...
	private class SOAPInvocationHandler implements InvocationHandler {
		...
		public Object invoke(Object proxy, Method method, Object[] args)throws Throwable {
			...
			SoapObject object = new SoapObject(VBoxMonitorActivity.NAMESPACE, i+"_"+method.getName());
