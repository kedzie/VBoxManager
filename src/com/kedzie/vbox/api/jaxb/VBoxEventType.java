...
public enum VBoxEventType implements Serializable {
	...
	INVALID("Invalid"), ANY("Any"), VETOABLE("Vetoable"), MACHINE_EVENT(
			"MachineEvent"), SNAPSHOT_EVENT("SnapshotEvent"), INPUT_EVENT(
			"InputEvent"), LAST_WILDCARD("LastWildcard"), ON_MACHINE_STATE_CHANGED(
			"OnMachineStateChanged"), ON_MACHINE_DATA_CHANGED(
			"OnMachineDataChanged"), ON_EXTRA_DATA_CHANGED("OnExtraDataChanged"), ON_EXTRA_DATA_CAN_CHANGE(
			"OnExtraDataCanChange"), ON_MEDIUM_REGISTERED("OnMediumRegistered"), ON_MACHINE_REGISTERED(
			"OnMachineRegistered"),
