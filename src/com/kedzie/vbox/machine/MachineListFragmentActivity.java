...
public class MachineListFragmentActivity extends BaseActivity implements OnTreeNodeSelectListener {
	...
	private class LogoffTask extends DialogTask<Void, Void>	{
		public LogoffTask(VBoxSvc vmgr) { 
			super( "LogoffTask", MachineListFragmentActivity.this, vmgr, R.string.logging_off_progress);
		}
		@Override
		...
		protected void onPostExecute(Void result) {
			...
			NavUtils.navigateUpFromSameTask(MachineListFragmentActivity.this);
		}
	}
	...
	private void onMachineSelected(IMachine machine) {
		if (_dualPane) {
			...
			Intent intent = new Intent(this, MachineFragmentActivity.class).putExtra(VBoxSvc.BUNDLE, (Parcelable)_vmgr);
