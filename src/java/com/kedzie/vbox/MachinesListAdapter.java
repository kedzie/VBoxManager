...
public class MachinesListAdapter extends BaseAdapter {
	...
	private VBoxMonitorActivity ctx;

	public MachinesListAdapter(VBoxMonitorActivity context, List<IMachine> machines) {
		this.ctx=context;
		_machines = machines;
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if (view == null) {
			...
			ImageView osTypeImage = (ImageView)view.findViewById(R.id.ostype);
			osTypeImage.setImageResource(R.drawable.os_virtualbox);
			try {
				SoapObject obj = new SoapObject(VBoxMonitorActivity.NAMESPACE, "IVirtualBox_getGuestOSType");
		...
		((ImageView)view.findViewById(R.id.state)).setImageResource(Resources.get("state_"+m.getState().toLowerCase()));
		return view;
	}
