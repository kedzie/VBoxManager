...
public interface IPerformanceCollector extends IRemoteObject {
	...
	public List<IPerformanceMetric> setupMetrics(@KSOAP("metricNames")String []metrics, @KSOAP("objects")Collection<String> objects,@KSOAP(type="unsignedInt", value="period") int period, @KSOAP(type="unsignedInt", value="count")int count) throws IOException;
