...
public interface IPerformanceCollector extends IManagedObjectRef, Parcelable {
    ...
    static final ClassLoader LOADER = IPerformanceCollector.class.getClassLoader();

    public static Parcelable.Creator<IPerformanceCollector> CREATOR = new Parcelable.Creator<IPerformanceCollector>() {
        @Override
        public IPerformanceCollector createFromParcel(Parcel in) {
            VBoxSvc vmgr =  in.readParcelable(LOADER);
            String id = in.readString();
            Map<String, Object> cache = new HashMap<String, Object>();
            in.readMap(cache, LOADER);
            return (IPerformanceCollector) vmgr.getProxy(IPerformanceCollector.class, id, cache); 
        }

        @Override
        public IPerformanceCollector[] newArray(int size) {
            return new IPerformanceCollector[size];
        }
    };
