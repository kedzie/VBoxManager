...
public interface IConsole extends IManagedObjectRef {
    ...
    @KSOAP public MachineState getState() throws IOException;
	 ...
	 * @throws IOException
	 */
    @KSOAP public IProgress powerUp() throws IOException;
	
	/**
	 * @return
	 * @throws IOException
	 */
    @KSOAP public IProgress powerUpPaused() throws IOException;
	/**
	 * @return
	 * @throws IOException
	 */
    @KSOAP public IProgress powerDown() throws IOException;
	
	/**
	 * @throws IOException
	 */
    @KSOAP public void sleepButton() throws IOException;
	
	/**
	 * @throws IOException
	 */
    @KSOAP public void powerButton() throws IOException;
	
	/**
	 * @throws IOException
	 */
    @KSOAP public void reset() throws IOException;
	
	/**
	 * @throws IOException
	 */
    @KSOAP public void pause() throws IOException;
	
	/**
	 * @throws IOException
	 */
    @KSOAP public void resume() throws IOException;
	
	/**
	 * @return
	 * @throws IOException
	 */
    @KSOAP public IProgress saveState() throws IOException;

    @KSOAP public void adoptSavedState(@KSOAP("saveStateFile") String saveStateFile) throws IOException;
    @KSOAP public void discardSavedState( @KSOAP("fRemoveFile") boolean removeFile) throws IOException;

    @KSOAP public IProgress takeSnapshot(@KSOAP("name") String name, @KSOAP("description") String description) throws IOException;
    @KSOAP public IProgress deleteSnapshot(@KSOAP(value="id") String snapshot) throws IOException;
    @KSOAP public IProgress deleteSnapshotAndChildren(@KSOAP(value="id") String snapshot) throws IOException;
    @KSOAP public IProgress deleteSnapshotRange(@KSOAP("startId") String startId, @KSOAP("endId") String endId) throws IOException;
    @KSOAP public IProgress restoreSnapshot(@KSOAP("snapshot") ISnapshot snapshot) throws IOException;
}
