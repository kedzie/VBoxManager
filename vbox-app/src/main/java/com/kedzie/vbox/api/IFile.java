...
public interface IFile extends IManagedObjectRef {
	...
	public Integer write(@KSOAP("data") String data, @KSOAP(type="unsignedInt", value="timeoutMS") int timeoutMS);
    
	public Integer writeAt(@KSOAP(type="unsignedInt", value="offset") long offset, @KSOAP("data") String data, @KSOAP(type="unsignedInt", value="timeoutMS") int timeoutMS);
}
