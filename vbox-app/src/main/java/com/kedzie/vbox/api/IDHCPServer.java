...
public interface IDHCPServer extends IManagedObjectRef, Parcelable {
	...
	@Asyncronous @KSOAP public void setConfiguration(@KSOAP("IPAddress") String ipAddress, @KSOAP("networkMask") String networkMask, @KSOAP("FromIPAddress") String fromIPAddress,@KSOAP("ToIPAddress") String toIPAddress);
	
	@Asyncronous @KSOAP public void start();
	
	@Asyncronous @KSOAP public void stop();
}
